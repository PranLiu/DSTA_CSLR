...
class Processor():
    ...
    def loading(self):
        ...
        # 将注意力参数传递给模型
        model_args = self.arg.model_args.copy()
        if hasattr(self.arg, 'attention_params') and self.arg.attention_params is not None:
            model_args['attention_params'] = self.arg.attention_params
